...
namespace lks.uc
{
    public partial class ucPengaturan : UserControl
    {
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lengkapi semua field!", "Field Empty!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
        ...
        private void btnSImpan_Click(object sender, EventArgs e)
        {
            ...
            if (Double.TryParse(txtLat.Text, out lat) && Double.TryParse(txtLng.Text, out lng))
            {
                ...
                MessageBox.Show("Berhasil Disimpann", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
