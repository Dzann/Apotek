    ...
    public partial class ucKelolaResep : UserControl
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (String.IsNullOrEmpty(txtNoResep.Text) || String.IsNullOrEmpty(txtNamaObat.Text) || String.IsNullOrEmpty(txtNamaObat.Text) || String.IsNullOrEmpty(txtNamaDokter.Text) || String.IsNullOrEmpty(txtQty.Text))
                {
        ...
        private void dgResep_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
