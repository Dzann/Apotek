...
namespace lks.models
{
    class Resep
    {
        ...
        {
            string sql = "INSERT INTO resep VALUES(@no_resep, @tgl_resep, @nama_pasien, @nama_dokter, @obat_resep, @stok)";
        ...
        {
            string sql = "UPDATE resep SET no_resep = @no_resep, tgl_resep = @tgl_resep, nama_pasien = @nama_pasien, nama_dokter = @nama_dokter, obat_resep = @obat_resep, stok = @stok WHERE id = @id";
            var args = new Dictionary<string, object>
            {
                {"@id",resep.id},
                {"@no_resep",resep.no_resep},
